...
public class Eagle : MonoBehaviour {
    ...
    private static Vector3 ORIGIN = new Vector3(40.5f, 72f, 46.1f);
    ...
    void Start()
    {
        ...
        _seed = Mathf.Repeat(12345.5678f * Random.value * (_position.x + _position.y + _position.z), 1.0f);

        //set an initial random velocity and drift
        _velocity = _seed * 0.4f + 0.125f;
    ...
    private void UpdatePosition()
    {
        ...
        _direction.y = Mathf.Lerp(_direction.y , -0.01f, 1.0f / 18.5f);
